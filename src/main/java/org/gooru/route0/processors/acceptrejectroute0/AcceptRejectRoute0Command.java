...
class AcceptRejectRoute0Command {
  ...
  public static AcceptRejectRoute0Command builder(EventBusMessage input) {
    AcceptRejectRoute0Command command = buildFromJsonObject(input.getUserId(),
