 ...
 * @author ashish.
 */
public class UserRoute0ContentDetailModelMapper implements
    ResultSetMapper<UserRoute0ContentDetailModel> {

  @Override
  public UserRoute0ContentDetailModel map(int index, ResultSet r, StatementContext ctx)
      throws SQLException {
    ...
    model.setCollectionType(
        CollectionModel.CollectionModelType.builder(r.getString(Attributes.COLLECTION_TYPE)));
