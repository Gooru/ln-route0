...
/**
 * Builder class to help create {@link CompetencyRouteModel} from {@link
 * org.gooru.route0.infra.data.competency.CompetencyRoute}
 *
 * @author ashish.
 */
class CompetencyRouteModelBuilder {
  ...
  CompetencyRouteModel build(SubjectCode subjectCode, CompetencyRoute competencyRoute) {
    ...
    domainsAsString = competencyRoute.getDomains().stream().map(DomainCode::getCode)
