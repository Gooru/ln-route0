...
class ContentRoutePersisterService implements ContentRoutePersister {
  ...
  private void updateRouteInfoForContentRouteWithPath() {
    getPersisterDao()
        .updateRouteInfoForRoute0Content(contentRouteId,
            contentRouteModelWithPathIds.toJson().toString());
  }
  ...
  private void createRouteDetails() {
    detailModels = new UserRoute0ContentDetailModelsBuilder()
        .build(contentRouteModel, contentRouteId);
  }
