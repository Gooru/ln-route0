...
import static org.gooru.route0.infra.services.competencyroutetocontentroutemapper.ContentRouteModelJsonRepresentation.CollectionModelJsonRepresentation;
import static org.gooru.route0.infra.services.competencyroutetocontentroutemapper.ContentRouteModelJsonRepresentation.LessonModelJsonRepresentation;
import static org.gooru.route0.infra.services.competencyroutetocontentroutemapper.ContentRouteModelJsonRepresentation.UnitModelJsonRepresentation;
...
class ContentRouteModelJsonRenderer {
  ...
  private List<LessonModelJsonRepresentation> getLessonModelJsonRepresentationForUnit(
      UnitModel unitModel) {
    ...
    for (LessonModel lessonModel : lessonModels) {
      ...
      lessonModelJsonRepresentation
          .setCollections(getCollectionModelJsonRepresentationForLesson(lessonModel));
